...
def run_flux_both_sites_hourly_analysis(nc=7, data_folder='DATA/Processed/',
    ...
    return df_filtered, df_cluster_means, df_monthly_prob, df_hourly_prob, colnames_responses, colnames_drivers
...
if __name__ == '__main__':
    ...
    df_filtered, df_cluster_means, df_monthly_prob, df_hourly_prob, colnames_responses, colnames_drivers = \
