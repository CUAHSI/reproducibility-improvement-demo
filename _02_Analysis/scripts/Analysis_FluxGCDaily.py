...
def run_flux_gc_daily_analysis(nc=6, data_folder='DATA/Processed/',
    ...
    return df_filtered, df_cluster_means, df_monthly_prob, df_yearly_prob, df_wet_dry_prob, colnames_responses, colnames_drivers
...
if __name__ == '__main__':
    ...
    df_filtered, df_cluster_means, df_monthly_prob, df_yearly_prob, df_wet_dry_prob, colnames_responses, colnames_drivers = \
