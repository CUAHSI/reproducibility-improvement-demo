...
def run_root_soil_nebraska_analysis(nc=9, data_folder='DATA/Processed/',
    ...
    return df_filtered, df_cluster_means, df_hourly_prob, df_monthly_prob, df_yearly_prob, colnames_responses, colnames_drivers
...
if __name__ == '__main__':
    ...
    df_filtered, df_cluster_means, df_hourly_prob, df_monthly_prob, df_yearly_prob, colnames_responses, colnames_drivers = \
